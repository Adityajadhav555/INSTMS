...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $sql = "INSERT INTO `certificate` ( `nit_name`,`sport`,`tournament`, `link`) VALUES ('$nit_name','$sport','$tournament', '$link')";
...
<html lang="en">
  ...
  <body>
    ...
    echo ' <div class="alert alert-success alert-dismissible fade show" role="alert">
        <strong>Success!</strong> Certificate Uploaded !
    ...
    <div class="container my-4">
     <h1 class="text-center">Add Certificate</h1>
     <form action="add_certificate.php" method="post">
     <div class="form-group">
        <label for="nit_name">Enter NIT Name</label>
     ...
     <div class="form-group">
        <label for="tournament">Enter tournament Name</label>
         <input type="text" id="tournament" name="tournament" class="form-control">
     </div>
       <div class="form-group">
         <label for="link">Enter the link for certificate</label>
